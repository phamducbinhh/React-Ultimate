...
const BlogArea = (props: any) => {
  const arr = []
  const { currentPost, isLoading } = props
  const tags = ['organic', 'foods', 'tasty']
  const comments = currentPost.comments
  const totalComments = comments && Object.keys(comments).length

  // const currentUser = JSON.parse(localStorage.getItem('login') as string) || {}
                              ...
                              {previousPost === null ? (
                                ...
                                <>
                                  ...
                                  <h4 className='hover-title red-color'>
                                    <Link to={`/blog/${previousPost.id - 1}`}>
                                      {previousPost.title ? previousPost.title.slice(0, 20) : <></>}
                                    </Link>
                                  </h4>
                                </>
                              )}
                          ...
                          <Grid item sm={5} xs={12}>
                            ...
                            >
                              {nextPost === null ? (
                                ...
                                <>
                                  <span className='hover-title red-color'>
                                    <Link to={`/blog/${nextPost.id - 1}`}>Next Post</Link>
                                  </span>
                                  <h4 className='hover-title red-color'>
                                    <Link to={`/blog/${nextPost.id - 1}`}>
                                      {nextPost.title ? nextPost.title.slice(0, 20) : <></>}
                                    </Link>
                                  </h4>
                                </>
                              )}
                      ...
                      <Box className='author'>
                        ...
                        <Box className='author-text'>
                          ...
                          <p>
                            ...
                            laboris nisi ut aliquip ex ea commodo consequa aute irure dolor.{' '}
                          </p>
                        </Box>
                      </Box>
